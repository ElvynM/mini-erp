...
<div class="container">
    ...
    <form action="{{ route('cupons.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="valor_desconto" name="valor_desconto" required value="{{ old('valor_desconto') }}">
        </div>
        <div class="mb-3">
            <label for="valor_minimo" class="form-label">Valor Mínimo</label>
            <input type="number" step="0.01" class="form-control" id="valor_minimo" name="valor_minimo" required value="{{ old('valor_minimo') }}">
        </div>
        <div class="mb-3">
